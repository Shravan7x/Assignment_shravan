  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 mb-8">
        ...
        <StatsCard title="Pending" value={stats?.pending || 0} color="text-amber-600" />
        ...
        <StatsCard title="Total Approved Amount" value={formatCurrency(stats?.totalApprovedAmount || 0)} color="text-green-600" />
      </div>
